...
MAIN_MENU_STEP_FORWARD_VALUE = 7
MAIN_MENU_STEP_BACKWARD_VALUE = -7

BOOLEAN_STEP_FORWARD_VALUE = 5
BOOLEAN_STEP_BACKWARD_VALUE = -5

INVERSE_STEP_FORWARD_VALUE = 5
INVERSE_STEP_BACKWARD_VALUE = -5

POSITIONAL_STEP_FORWARD_VALUE = 5
POSITIONAL_STEP_BACKWARD_VALUE = -5
